...
<script>
  ...
  function initializeComerciosPage() {
    ...
    MarketplaceApp.comercios = pageStores.map(store => ({
      ...
      foto: store.imagen_url || '/imagenes/blusa.png',
    }));
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\castr\OneDrive\Desktop\laravel\hola\ProjectMarket\market\resources\views/comercios.blade.php ENDPATH**/ ?>