...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        return response()->json(['message' => 'Bienvenido', 'user' => $request->session()->get('user')]);
    }
    ...
    public function registerBuyer(Request $request)
    {
        ...
        return response()->json(['message' => 'Cuenta creada', 'user' => $request->session()->get('user')]);
    }
    ...
    public function registerStore(Request $request)
    {
        ...
        return response()->json(['message' => 'Comercio registrado', 'user' => $request->session()->get('user')]);
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        $updatedUser = DB::table('usuarios')->where('id_usuario', $user['id_usuario'])->first();
        if ($user['tipo_usuario'] === 'cliente') {
            $updatedExtra = DB::table('clientes')->where('id_cliente', $user['id_usuario'])->first();
        } else {
            $updatedExtra = DB::table('vendedores')->where('id_vendedor', $user['id_usuario'])->first();
        }

        $request->session()->put('user', $this->normalizeUser((object) array_merge((array) $updatedUser, (array) $updatedExtra)));

        return response()->json(['message' => 'Perfil actualizado', 'user' => $request->session()->get('user')]);
    }
}
