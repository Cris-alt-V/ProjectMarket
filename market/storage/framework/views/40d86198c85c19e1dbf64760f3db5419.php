    ...
    <header>
        <div class="header-container">
            ...
            <nav>
                ...
                <?php if(session('user')): ?>
                    <a href="<?php echo e(url('/mensajes')); ?>" class="<?php echo e(Request::is('mensajes*') ? 'active' : ''); ?>">Mensajes</a>
                <?php endif; ?>
...
<?php /**PATH C:\Users\crist\OneDrive\Desktop\casdq\ProjectMarket\market\resources\views/layouts/app.blade.php ENDPATH**/ ?>